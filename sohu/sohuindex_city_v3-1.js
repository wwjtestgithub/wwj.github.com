...
var getLocal=function(){
	...
	(function transHenan() {
		if (/(ts|cn)41/ig.test(AdLoc.toLowerCase())) //将河南省的IP格式化为CN4100
		{
			AdLoc = AdLoc.toLowerCase().replace(/(ts|cn)(41)\d{2}/ig, "$14100");
		}
	})();
...
that.Run=function(){
	var hasData=["ts2102","cn2102","ts3205","cn3205","cn3502","ts3502","cn3702","ts3702","cn3302","ts3302","cn4100","ts4100"];
